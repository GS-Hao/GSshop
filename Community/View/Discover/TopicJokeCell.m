...
@implementation TopicJokeCell

+ (instancetype)cellWithTableView:(UITableView *)tableView{
    static NSString *identifier = @"joke";
    // 1.缓存中取
    //TopicJokeCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    TopicJokeCell *cell = nil;
    // 2.创建
    if (cell == nil) {
        cell = [[TopicJokeCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
    }
    return cell;
}
