...
+ (instancetype)cellWithTableView:(UITableView *)tableView{
    ...
    // 1.缓存中取
    //LikeCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    LikeCell *cell = nil;
    // 2.创建
    if (cell == nil) {
        cell = [[LikeCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
    }
    return cell;
}
