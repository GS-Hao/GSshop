//
//  GSFavorite+CoreDataProperties.h
//  xiangle
//
...
#import "GSFavorite+CoreDataClass.h"


NS_ASSUME_NONNULL_BEGIN

@interface GSFavorite (CoreDataProperties)

+ (NSFetchRequest<GSFavorite *> *)fetchRequest NS_SWIFT_NAME(fetchRequest());
