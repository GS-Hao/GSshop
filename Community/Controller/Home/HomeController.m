...
//    self.navigationItem.rightBarButtonItem.tintColor=bgColor;
...
-(void)setupTitlesView
{
    ...
    indicatorView.backgroundColor=bgColor;//橙色
    ...
    for (NSInteger i=0; i<titles.count; i++) {
        ...
        [btn setTitleColor:bgColor forState:UIControlStateDisabled];
