...
/** 备注 */
@property (strong, nonatomic) GSUser *field;
/** 备注 */
...
- (void)viewDidLoad {
    ...
    self.field = [AIDCoreDataManager getUserEntityById:[_cache[@"user_id"] intValue]];
...
//        self.field = [GSUser mj_objectWithKeyValues:responseObject];
//
//        [self initFieldData];
//        [self.tableView reloadData];
//        //设置头像
