...
- (void)loadData:(BOOL)first{
    ...
    NSMutableArray *more = [[NSMutableArray alloc] initWithArray:[AIDCoreDataManager getAllEntitys:[GSComment class]]];
    ...
    [obj getListByUserId:params successBlock:^(id  _Nonnull responseObject) {
        NSMutableArray *more = [GSComment mj_objectArrayWithKeyValuesArray:responseObject[@"list"]];
        [self.fields addObjectsFromArray:more];
