...
- (void)loadData:(BOOL)first{
    ...
    [obj gets:params successBlock:^(id  _Nonnull responseObject) {
        ...
        NSString *path = [[NSBundle mainBundle] pathForResource:@"Categorys" ofType:@"json"];
        NSData *data = [[NSData alloc] initWithContentsOfFile:path];
        NSDictionary *dic = [self dictionaryForJsonData:data];
        
        NSMutableArray *more = [Topic mj_objectArrayWithKeyValuesArray:dic[@"list"]];
